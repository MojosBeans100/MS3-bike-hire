...
def booked_or_not(bikes_dictionary):
    ...
    # if the user does not want us to look for alternatives
        ...
        # calculate total costs to be appended to email
        calculate_cost()

        # get last info required from gs to be appended to email
        bike_user_details()

        # organise this info into readable format for email
        booking_details()

        # send email to user and owner
        send_email()

        # add this booking info to the gs
        add_booking_to_gs()
